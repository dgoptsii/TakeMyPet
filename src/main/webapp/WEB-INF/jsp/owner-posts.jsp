                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4  col-12">
                                <div class="form-group text-center">
                                    ...
                                    <div class="slidecontainer">
                                        <input type="range" min="1" max="14" value="${maxDays}" name="maxDays"
                                               class="slider" id="nDays">
                                    </div>
                                    <script>
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                                <div class="form-col text-left">
                                                    <div class="form-group">
                                                        <label for="rating" class="pl-1"><b>Rating: <c:out
                                                        ...
                                                        <div id="rating" class="str_Rating_detail">
                                                            <div data-rating="<c:out value="${item.host.rating}"/>"
